      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-md p-6 space-y-4">
        {step === 1 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div><label className="block text-sm font-medium mb-1">Prix (HTG) *</label><input type="number" value={form.prix} onChange={e => handleChange('prix', e.target.value)} placeholder="Ex: 15000 ou 250000" className="w-full border rounded-lg px-4 py-3" required /></div>
